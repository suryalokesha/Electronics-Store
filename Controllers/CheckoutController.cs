    ...
    public class CheckoutController : BaseController
    {
        ...
        public CheckoutController()
        {
            states = new List<object> {
                new { SID = "NSW", SName = "Scotland" },
                new { SID = "VIC", SName = "London" },
                new { SID = "QLD", SName = "Edinburgh" },
                new { SID = "TAs", SName = "Northern Ireland" },
                new { SID = "NT", SName = "East Midlands" },
                new { SID = "SA", SName = "Bhirmingham" },
                new { SID = "WA", SName = "Leicester" },
                new { SID = "ACT", SName = "Nottingham" }
            };
        ...
        {
            ElectronicsStoreDbEntities context = new ElectronicsStoreDbEntities();

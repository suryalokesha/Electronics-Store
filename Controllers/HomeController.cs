...
namespace Electronics_Store.Controllers
{
    public class HomeController : BaseController
    {
        ...
        {
            ViewBag.Message = "Online Electronic store sells the best quality home appliances for your daily usage. There is no need to visit the store and you can pay using digital payment methods.";
